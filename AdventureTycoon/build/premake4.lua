...
solution "AdventureTycoon"
    ...
    configuration {"web"}
        ...
        buildoptions
        {
            "-DorxWEB_EXECUTABLE_NAME='\"AdventureTycoon.wasm\"'",
            "-pthread"
        }
        linkoptions
        {
            "--preload-file " .. copybase .. "/build/AdventureTycoon.obr@/",
    ...
    configuration {"web", "Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && AdventureTycoon -b ../build/AdventureTycoon.obr"}
        postbuildcommands {"del " .. path.translate(copybase, "\\") .. "\\build\\AdventureTycoon.obr"}

    configuration {"web", "not Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && ./AdventureTycoon -b ../build/AdventureTycoon.obr"}
        postbuildcommands {"rm " .. copybase .. "/build/AdventureTycoon.obr"}
...
project "AdventureTycoon"
    ...
    configuration {"*Bundle*", "not web"}
        debugargs {"-b", "AdventureTycoon.obr"}
